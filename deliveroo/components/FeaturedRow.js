  ...
  return (
    <View>
      ...
      <ScrollView horizontal contentContainerStyle={{ paddingHorizontal: 15 }} showsHorizontalScrollIndicator={false} className="pt-4">
        <RestaurantCard id={123} imgUrl="https://links.papareact.com/gn7" title="yo sushi" short_description="test desciptions" rating={4.5} genre="Japanese" address="123 main street" dishes={[]} long={1234445} lati={244555}></RestaurantCard>
        <RestaurantCard id={123} imgUrl="https://links.papareact.com/gn7" title="yo sushi" short_description="test desciptions" rating={4.5} genre="Japanese" address="123 main street" dishes={[]} long={1234445} lati={244555}></RestaurantCard>
        <RestaurantCard id={123} imgUrl="https://links.papareact.com/gn7" title="yo sushi" short_description="test desciptions" rating={4.5} genre="Japanese" address="123 main street" dishes={[]} long={1234445} lati={244555}></RestaurantCard>
        <RestaurantCard id={123} imgUrl="https://links.papareact.com/gn7" title="yo sushi" short_description="test desciptions" rating={4.5} genre="Japanese" address="123 main street" dishes={[]} long={1234445} lati={244555}></RestaurantCard>
        <RestaurantCard id={123} imgUrl="https://links.papareact.com/gn7" title="yo sushi" short_description="test desciptions" rating={4.5} genre="Japanese" address="123 main street" dishes={[]} long={1234445} lati={244555}></RestaurantCard>
